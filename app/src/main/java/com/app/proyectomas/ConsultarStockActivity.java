...
public class ConsultarStockActivity extends AppCompatActivity {
    ...
    private ConsultarStockCustomAdapter consultarStockCustomAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        consultarStockCustomAdapter = new ConsultarStockCustomAdapter(this,0,productos);
        lvProductos.setAdapter(consultarStockCustomAdapter);
        ...
        btnBuscarProductoXQR.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                IntentIntegrator integrator =  new IntentIntegrator(ConsultarStockActivity.this);
    ...
    public void buscarProductoPorCodigo(String pCodigo){
        ...
        consultarStockCustomAdapter = new ConsultarStockCustomAdapter(this,0,productos);
        lvProductos.setAdapter(consultarStockCustomAdapter);
        consultarStockCustomAdapter.notifyDataSetChanged();
    }
